  ...
  def test do
    ...
    hello =
      %{
        "type" => "hello",
        "jwt" =>
          "eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3MzQ3NTQ3NjIsImlkIjoiYmFhMmI4OWEtNWEyOS00MGI2LWEzNTUtZDUxNmE5NTZlNjg3In0.ra87okNE0X6_gnvMOv_qXvEgfXmNgulZJiuqMNRJmqxnAWJ_GOiMODCyn4dvK3DT9CAgNVDdhMOWH--c-A2PDQ"
      }
      |> :json.encode()
      |> IO.iodata_to_binary()
